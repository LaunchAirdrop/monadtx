...
async function executeTayaSwapRouteWithAmount(index, total, wallet, path, inputIsETH = true, amountInOverride, nonce = null) {
  ...
  try {
    ...
    addLog(`Taya: Memulai Swap dengan jumlah: ${ethers.formatEther(amountIn)} MON`, "taya");
...
(async () => {
  ...
  while (true) {
    ...
    addLog(`[MAIN] Menjalankan ${loopCount} transaksi hari ini`, "main");
    ...
    addLog(`[MAIN] Selesai ${loopCount} transaksi. Tunggu 24 jam...`, "main");
